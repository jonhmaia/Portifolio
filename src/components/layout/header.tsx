...
function HeaderContent() {
  ...
  return (
    <header className={cn('jm-nav', isScrolled && 'jm-nav--scrolled')}>
        ...
        <div className="jm-nav__actions">
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
              <Button variant="ghost" size="icon" className="jm-nav__menu md:hidden" aria-label={tA11y('navigationMenu')}>
                <Menu aria-hidden="true" />
              </Button>
            </SheetTrigger>
            <SheetContent side="right" className="jm-menu-panel w-full border-l-0 p-0 sm:max-w-md">
