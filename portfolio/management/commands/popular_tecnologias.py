...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        tecnologias_data = [
            ...
            {'nome': 'C', 'categoria': 'linguagem', 'icone': 'fas fa-code', 'cor': '#A8B9CC'},
            ...
            # Frameworks Web
            {'nome': 'Django', 'categoria': 'framework', 'icone': 'fab fa-python', 'cor': '#092e20'},
            ...
            {'nome': 'Bubble', 'categoria': 'ferramenta', 'icone': 'fas fa-circle', 'cor': '#007bff'},
            ...
            {'nome': 'Supabase', 'categoria': 'banco', 'icone': 'fas fa-database', 'cor': '#3ecf8e'},
            {'nome': 'n8n', 'categoria': 'ferramenta', 'icone': 'fas fa-project-diagram', 'cor': '#ea4b71'},
